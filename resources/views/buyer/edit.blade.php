<x-app-layout>
    <form method="post" action="{{ route('buyer.update', $buyer->id) }}" class="mt-6 space-y-6">
        <x-content-header route="buyer.index" buttonText="Lista nabywców">
            {{ __('Edytuj nabywce') }} {{ $buyer->company_name }}
        </x-content-header>
        @csrf
        @method('PATCH')
        <div class="py-12">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 py-2">
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full"
                                    :value="old('name', $buyer->name)" required autofocus autocomplete="name" />
                            ...
                            <div class="w-full md:w-1/2 px-3 py-2">
                                ...
                                <x-text-input id="company_name" name="company_name" type="text"
                                    class="mt-1 block w-full" :value="old('company_name', $buyer->company_name)" required autofocus
                            ...
                            <div class="w-full md:w-1/4 px-3 py-2">
                                ...
                                <x-text-input id="krs" name="krs" type="text" class="mt-1 block w-full"
                                    :value="old('krs', $buyer->krs)" autofocus autocomplete="krs" />
